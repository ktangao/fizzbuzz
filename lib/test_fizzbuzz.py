...
class TestFizzBuzz(unittest.TestCase):
	...
	def test_sequence(self):
		for (int1, int2, limit, str1, str2) in [
			...
			fizzbuzz = FizzBuzz(int1, int2, limit, str1, str2)
